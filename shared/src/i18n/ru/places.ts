...
const places: TranslationStrings = {
  ...
  'places.providerUnavailable': 'Провайдер недоступен',
  'places.hoursUnavailable': 'Часы работы недоступны',
  'places.source': 'Источник: {source}',
  'places.fetchedAt': 'Получено: {fetchedAt}',
};
