...
const places: TranslationStrings = {
  ...
  'places.providerUnavailable': 'Provider non disponibile',
  'places.hoursUnavailable': 'Orari non disponibili',
  'places.source': 'Fonte: {source}',
  'places.fetchedAt': 'Recuperato: {fetchedAt}',
};
