...
const places: TranslationStrings = {
  ...
  'places.providerUnavailable': 'Dostawca niedostępny',
  'places.hoursUnavailable': 'Godziny otwarcia niedostępne',
  'places.source': 'Źródło: {source}',
  'places.fetchedAt': 'Pobrano: {fetchedAt}',
};
