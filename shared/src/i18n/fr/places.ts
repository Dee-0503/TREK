...
const places: TranslationStrings = {
  ...
  'places.providerUnavailable': 'Fournisseur indisponible',
  'places.hoursUnavailable': 'Horaires indisponibles',
  'places.source': 'Source : {source}',
  'places.fetchedAt': 'Récupéré : {fetchedAt}',
};
