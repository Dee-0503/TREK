...
const places: TranslationStrings = {
  ...
  'places.providerUnavailable': 'Proveïdor no disponible',
  'places.hoursUnavailable': 'Horari no disponible',
  'places.source': 'Font: {source}',
  'places.fetchedAt': 'Obtingut: {fetchedAt}',
};
